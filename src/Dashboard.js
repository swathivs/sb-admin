        ...
        <div className="card shadow mb-4">
            ...
            <div className="card-body">
                ...
                <div className="progress mb-4">
                    <div className="progress-bar bg-danger a5" role="progressbar"></div>
                </div>
                <h4 className="small font-weight-bold">Sales Tracking <span
                        className="float-right">40%</span></h4>
                <div className="progress mb-4">
                    <div className="progress-bar bg-warning a2" role="progressbar"></div>
                </div>
                <h4 className="small font-weight-bold">Customer Database <span
                        className="float-right">60%</span></h4>
                <div className="progress mb-4">
                    <div className="progress-bar a6" role="progressbar"></div>
                </div>
                ...
                <div className="progress">
                    <div className="progress-bar bg-success a7" role="progressbar"></div>
                </div>
            </div>
        </div>
